...
class FileDescriptorProto(_message.Message):
    __slots__ = ("name", "package", "dependency", "public_dependency", "weak_dependency", "message_type", "enum_type", "service", "extension", "options", "source_code_info", "syntax", "edition", "edition_enum")
    ...
    EDITION_ENUM_FIELD_NUMBER: _ClassVar[int]
    name: str
    package: str
...
class FieldOptions(_message.Message):
    __slots__ = ("ctype", "packed", "jstype", "lazy", "unverified_lazy", "deprecated", "weak", "debug_redact", "retention", "targets", "edition_defaults", "features", "uninterpreted_option")
    Extensions: _python_message._ExtensionDict
    ...
    class EditionDefault(_message.Message):
        __slots__ = ("edition", "edition_enum", "value")
        EDITION_FIELD_NUMBER: _ClassVar[int]
        EDITION_ENUM_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        edition: str
        edition_enum: Edition
        value: str
        def __init__(self, edition: _Optional[str] = ..., edition_enum: _Optional[_Union[Edition, str]] = ..., value: _Optional[str] = ...) -> None: ...
...
class EnumValueOptions(_message.Message):
    __slots__ = ("deprecated", "features", "debug_redact", "uninterpreted_option")
    Extensions: _python_message._ExtensionDict
    DEPRECATED_FIELD_NUMBER: _ClassVar[int]
    FEATURES_FIELD_NUMBER: _ClassVar[int]
    DEBUG_REDACT_FIELD_NUMBER: _ClassVar[int]
...
class FeatureSet(_message.Message):
    __slots__ = ("field_presence", "enum_type", "repeated_field_encoding", "message_encoding", "json_format")
    Extensions: _python_message._ExtensionDict
    ...
    def __init__(self, field_presence: _Optional[_Union[FeatureSet.FieldPresence, str]] = ..., enum_type: _Optional[_Union[FeatureSet.EnumType, str]] = ..., repeated_field_encoding: _Optional[_Union[FeatureSet.RepeatedFieldEncoding, str]] = ..., message_encoding: _Optional[_Union[FeatureSet.MessageEncoding, str]] = ..., json_format: _Optional[_Union[FeatureSet.JsonFormat, str]] = ...) -> None: ...

class FeatureSetDefaults(_message.Message):
    __slots__ = ("defaults", "minimum_edition", "maximum_edition", "minimum_edition_enum", "maximum_edition_enum")
    class FeatureSetEditionDefault(_message.Message):
        __slots__ = ("edition", "edition_enum", "features")
        EDITION_FIELD_NUMBER: _ClassVar[int]
        EDITION_ENUM_FIELD_NUMBER: _ClassVar[int]
        FEATURES_FIELD_NUMBER: _ClassVar[int]
        edition: str
        edition_enum: Edition
        features: FeatureSet
        def __init__(self, edition: _Optional[str] = ..., edition_enum: _Optional[_Union[Edition, str]] = ..., features: _Optional[_Union[FeatureSet, _Mapping]] = ...) -> None: ...
    DEFAULTS_FIELD_NUMBER: _ClassVar[int]
    MINIMUM_EDITION_FIELD_NUMBER: _ClassVar[int]
    MAXIMUM_EDITION_FIELD_NUMBER: _ClassVar[int]
    MINIMUM_EDITION_ENUM_FIELD_NUMBER: _ClassVar[int]
    MAXIMUM_EDITION_ENUM_FIELD_NUMBER: _ClassVar[int]
    defaults: _containers.RepeatedCompositeFieldContainer[FeatureSetDefaults.FeatureSetEditionDefault]
    minimum_edition: str
    maximum_edition: str
    minimum_edition_enum: Edition
    maximum_edition_enum: Edition
    def __init__(self, defaults: _Optional[_Iterable[_Union[FeatureSetDefaults.FeatureSetEditionDefault, _Mapping]]] = ..., minimum_edition: _Optional[str] = ..., maximum_edition: _Optional[str] = ..., minimum_edition_enum: _Optional[_Union[Edition, str]] = ..., maximum_edition_enum: _Optional[_Union[Edition, str]] = ...) -> None: ...
